...
MACRO_CONFIG_INT(ClAntiPingInputMs, cl_antiping_input_ms, 200, 0, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(ClTestInputPred, cl_test_input_pred, 0, 0, 1000, CFGFLAG_CLIENT, "")
